...
| 01 电源监测 | code_ready | 冻结 ADC 引脚、分压值并用万用表标定 |
...
| 06 STP-23L | code_ready / 解码适配待协议 | 抓原始串口数据并取得厂家帧协议 |
| 07 视觉 UART | code_ready / 已接 UART1 | PA8/PA9 连续帧、错帧与拔线测试 |
| 08 二维云台 | code_ready | 冻结驱动类型、引脚、零位与限位 |
